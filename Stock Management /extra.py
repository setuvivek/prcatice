...
class CustomerMaster:
    ...
    def load_data(self):
        ...
        for row in sheet.iter_rows(min_row=2, values_only=True):
            ...
            self.cust_info[cust_id] = {'cust_name': cust_name, 'cust_type': cust_types.split(','), 'cust_pan': cust_pan}

    # Rest of your methods...

class ProductMaster(CustomerMaster):
    def __init__(self):
        super().__init__()
...
class CustomerMaster:
    ...
    def __init__(self):
        self.id = wb["customer"].max_row
        self.cust_id = itertools.count(self.id)
        self.sheet1 = wb["customer"]
        self.load_data()
...
class ProductMaster(CustomerMaster):
    ...
    def __init__(self):
        super().__init__()
        self.id1 = wb["product"].max_row
        self.prod_id = itertools.count(self.id1)
        self.sheet2 = wb["product"]
        self.load_data()
...
class StockMove(ProductMaster):
    ...
    def __init__(self):
        super().__init__()
        self.id2 = wb["stock"].max_row
        self.stock_id = itertools.count(self.id2)
        self.sheet3 = wb["stock"]
        self.load_data()
