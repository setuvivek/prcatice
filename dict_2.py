mylist1 = [{'product': 'furn_0789', 'quantity': 16.0, 'warehouse': 'newyork'},
          {'product': 'furn_0789', 'quantity': 16.0, 'warehouse': 'newyork'},
          {'product': 'furn_0789', 'quantity': 16.0, 'warehouse': 'newyork'},
          {'product': 'furn_6666', 'quantity': 16.0, 'warehouse': 'newyork'},
          {'product': 'e-com08', 'quantity': 18.0, 'warehouse': 'san francisco'},
          {'product': 'e-com08', 'quantity': 500.0, 'warehouse': 'san francisco'},
...
for item in mylist1:
    ...
    res = {'product':product,'quantity':quantity}
