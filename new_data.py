import pandas as pd
# readfile = pd.read_csv('/home/setu52/Desktop/PycharmProjects/pythonProject/py/son.csv')
# readfile.to_excel("/home/setu52/Desktop/PycharmProjects/pythonProject/py/student.xlsx", sheet_name="Put", index=False)
# df = pd.read_excel("/home/setu52/Desktop/PycharmProjects/pythonProject/py/student.xlsx")
# df.head
# df['optionType'].unique()
# for state in df['optionType'].unique():
#     print(state)
#     writer = pd.ExcelWriter("output.xlsx", engine='xlsxwriter')
# for state in df['optionType'].unique():
#     newDf = df[df['optionType'] == state]
#     newDf.to_excel(writer, sheet_name="call", index=False)
# for state in df['optionType'].unique():
#     newDf = df[df['optionType']== state]
#     newDf.to_excel(writer, sheet_name="put", index=False)
# import pandas as pd
...
for i in data:
    for j in data[i]:
        if j["optionType"] == "Call":
            call.append({"underlying": j["underlying"],
            ...
            put.append({"underlying": j["underlying"],
                        "identifier": j["identifier"],
                        "instrumentType": j["instrumentType"],
                        "instrument": j["instrument"],
                        "expiryDate": j["expiryDate"],
...
# with pd.ExcelWriter('/home/setu52/Downloads/result.xlsx') as write:
#     calldf.to_excel(write, 'Call')
#     putdf.to_excel(write, 'Put')
#csv file
with pd.ExcelWriter('separate.xlsx', engine = 'xlsxwriter')as excel_writer:
    Put.to_excel(excel_writer, sheet_name="Put", index=False)
    Call.to_excel(excel_writer, sheet_name="Call", index=False)
