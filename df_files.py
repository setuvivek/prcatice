...
# f = open('/home/setu/Documents/nse_data_prac.txt', 'r')
# print(f.read())
# with open('/home/setu/Documents/data_prac.csv', 'w') as file:
#      csv_writer = csv.writer(file)


# df = pd.read_csv('/home/setu/Documents/data_prac.csv')
# print(df.to_string())
x = {
    "value": [
        {
...
for i in x:
    for j in x[i]:
        op.append({'underlying': j['underlying'], 'identifier': j['identifier'], 'instrumentType': j['instrumentType'],
...
df = pd.DataFrame(op)
df.to_csv('/home/setu/Documents/data_prac.csv')
