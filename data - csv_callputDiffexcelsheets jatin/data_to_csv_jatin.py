...
with open(filename, 'w') as csvfile:
    ...
    writer.writerows(a["value"])
    writer.writerows(a["volume"])
...
def csv_to_excel(d_to_cs, excel_file):
    csv_data = []
    with open(d_to_cs) as file_obj:
...
if __name__ == "__main__":
    csv_to_excel("d_to_cs.csv", "books.xlsx")
