import csv
field_names = ["underlying","identifier","instrumentType","instrument","expiryDate","optionType","strikePrice","lastPrice",
               "pChange","openPrice","highPrice","lowPrice", "numberOfContractsTraded","totalTurnover","premiumTurnover","openInterest","underlyingValue"]
value = [
{
...
with open('exe6.csv', 'w') as csvfile:
